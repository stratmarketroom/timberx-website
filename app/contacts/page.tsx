...
const locations = [
  ...
  },
  {
    ...
    description:
      "Сучасна лінія автоматизованої нарізки та пресування металозубчатих пластин. Можливий візит на виробництво за попередньою домовленістю.",
            ...
            <div className="rounded-[1.5rem] border border-white/10 bg-[#202326]/88 p-6">
                ...
                {directContacts.map((contact) =>
                  contact.label === "Телефон" ? (
                    ...
                    >
                      <span>
                        ...
                        <AnalyticsLink
                          ...
                          eventParams={{ placement: "contacts_direct" }}
                      ...
                      <div className="flex items-center gap-2">
                        <AnalyticsLink
                          ...
                          eventParams={{ placement: "contacts_direct", source_cta: "contacts_telegram" }}
                          target="_blank"
                          rel="noreferrer"
                          aria-label="Telegram"
                        ...
                        <AnalyticsLink
                          ...
                          eventParams={{ placement: "contacts_direct", source_cta: "contacts_viber" }}
                          aria-label="Viber"
                          className="inline-flex h-9 w-9 items-center justify-center rounded-[10px] border border-[#F2994A]/34 bg-[rgba(242,153,74,0.12)] text-[#f4dfcf] transition hover:border-[#F2994A]/58 hover:bg-[#F2994A] hover:text-[#1B1D1F]"
                        >
                          <svg viewBox="0 0 24 24" className="h-4.5 w-4.5" fill="currentColor" aria-hidden="true">
                        ...
                        <AnalyticsLink
                          ...
                          eventParams={{ placement: "contacts_direct", source_cta: "contacts_whatsapp" }}
                          target="_blank"
                          rel="noreferrer"
                          aria-label="WhatsApp"
                          className="inline-flex h-9 w-9 items-center justify-center rounded-[10px] border border-[#F2994A]/34 bg-[rgba(242,153,74,0.12)] text-[#f4dfcf] transition hover:border-[#F2994A]/58 hover:bg-[#F2994A] hover:text-[#1B1D1F]"
                    ...
                    <p key={contact.label} className={`${bodyClass} text-base leading-7 text-[#d0d0d0]`}>
                      ...
                      <AnalyticsLink
                        href={contact.href}
                        eventName={contact.label === "Email" ? "email_click" : "contact_click"}
                        eventParams={{ placement: "contacts_direct" }}
                        className="font-medium text-[#f4dfcf] transition hover:text-[#f2994a]"
                      >
                        {contact.value}
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <AnalyticsLink
                  href="tel:+380674121310"
                  eventName="phone_click"
                  eventParams={{ placement: "contacts_cta" }}
