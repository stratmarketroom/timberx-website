...
const cases = [
  ...
  },
  {
    ...
    solution:
      "Інженерна комбінована система: клеєні балки та ферми на металозубчатих пластинах. Розрахунок у MiTek Pamir для точного врахування снігових і вітрових навантажень.",
    results: [
  ...
  },
  {
    ...
    imageAlt: "Серійна забудова ЖК з фермами з металозубчатими пластинами TimberX",
    gallery: [
      { src: "/images/fermy-mzp/case-zhk-serial.jpg", alt: "ЖК із серійним монтажем ферм з металозубчатими пластинами" },
      { src: "/images/fermy-mzp/object-crane-installation-1.jpg", alt: "Монтаж ферм з металозубчатими пластинами краном на об'єкті" },
      { src: "/images/fermy-mzp/object-block-building-1.jpg", alt: "Серійна забудова з фермами з металозубчатими пластинами TimberX" },
      { src: "/images/fermy-mzp/object-roof-joint-detail-1.jpg", alt: "Вузол покрівельної системи з металозубчатими пластинами" },
    ],
    challenge:
    ...
    solution:
      "Серійні комплекти ферм з металозубчатими пластинами за стандартом EN 1995-1-1. Кожен елемент нарізаний на ЧПУ-обладнанні з деревини сорту C22/C24.",
    results: [
...
const directions = [
  {
    ...
    description:
      "Масштабування серійної забудови, швидкісні кроквяні системи та ферми з металозубчатими пластинами.",
...
const trustItems = [
  {
    ...
    value: "10 років (офіційно в договорі)",
  },
  {
    icon: "projects" as IconName,
